...
# Find the four nearest restaurants
nearest_fastf = fast_food_finder.find_four_nearest(user_coord)

# Output the four nearest restaurants
print("\nThe four nearest restaurants to your location are:")
for i, restaurant in enumerate(nearest_fastf):
