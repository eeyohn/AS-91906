...
def main_window():
    ...
    program_title.place(relx=0.5, rely=0.70, anchor='center')  # Adjust relx and rely
    ...
    def open_search_window():
        ...
        global error_label  # Make error_label global so it's accessible in other functions
